using log4net;
using System;
using Bios.Communication.Packets;
...
using Bios.HabboHotel.Rooms.Chat;
using Bios.HabboHotel.Talents;
using Bios.HabboHotel.Bots;
using Bios.HabboHotel.Cache;
using Bios.HabboHotel.Rewards;
using Bios.HabboHotel.Badges;
...
using Bios.Core.FigureData;
using Bios.Core.Settings;
using Bios.Core.Language;
using Bios.HabboHotel.Catalog.FurniMatic;
using Bios.Communication.Packets.Incoming.LandingView;

namespace Bios.HabboHotel
{
    public class Game
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Game");
        ...
        public void Destroy()
        {
            ...
            GetClientManager();
            log.WarnFormat("Client Manager destroyed", "Bios.HabboHotel.Game", ConsoleColor.DarkYellow);
        }
