...
namespace Bios.HabboHotel.Users.Process
{
	sealed class ProcessComponent
	{
		private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Users.Process.ProcessComponent");
		...
		public void Run(object State)
		{
			try
			{
				...
				if (_player.GetClient() != null)
					BiosEmuThiago.GetGame().GetAchievementManager().ProgressAchievement(_player.GetClient(), "ACH_AllTimeHotelPresence", 1);
