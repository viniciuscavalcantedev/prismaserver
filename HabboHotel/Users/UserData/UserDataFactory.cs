...
using Bios.HabboHotel.Users.Authenticator;
    ...
    public class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            using (IQueryAdapter dbClient = BiosEmuThiago.GetDatabaseManager().GetQueryReactor())
            {
                ...
                if (BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(UserId) != null)
                {
                    errorCode = 2;
                    BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(UserId).Disconnect();
                    return null;
                }
            ...
            foreach (DataRow dRow in dFriends.Rows)
            {
                ...
                bool friendHideOnline = BiosEmuThiago.EnumToBool(dRow["hide_online"].ToString());
                bool friendHideRoom = BiosEmuThiago.EnumToBool(dRow["hide_inroom"].ToString());
            ...
            {
                rooms.Add(BiosEmuThiago.GetGame().GetRoomManager().FetchRoomData(Convert.ToInt32(dRow["id"]), dRow));
            }
        ...
        public static UserData GetUserData(int UserId)
        {
            ...
            using (IQueryAdapter dbClient = BiosEmuThiago.GetDatabaseManager().GetQueryReactor())
            {
                ...
                BiosEmuThiago.GetGame().GetClientManager().LogClonesOut(Convert.ToInt32(UserId));
