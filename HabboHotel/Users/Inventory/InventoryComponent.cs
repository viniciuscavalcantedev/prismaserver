...
namespace Bios.HabboHotel.Users.Inventory
{
    public class InventoryComponent
    {
        ...
        {
            return BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(_userId);
        }
