...
namespace Bios.HabboHotel.Subscriptions
{
    ...
    {
        private static ILog log = LogManager.GetLogger("Bios.HabboHotel.Subscriptions.SubscriptionManager");
        ...
        public void Init()
        {
            ...
            log.Info("» Cobrado: " + _subscriptions.Count + " assinaturas! - BY: Thiago Araujo");
        }
