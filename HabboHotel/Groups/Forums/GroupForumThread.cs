...
namespace Bios.HabboHotel.Groups.Forums
{
    public class GroupForumThread
    {
        ...
        {
            BiosEmuThiago.GetGame().GetClientManager().OnClientDisconnect += GroupForumThread_OnClientDisconnect;
            ...
            DeletedTimestamp = (int)BiosEmuThiago.GetUnixTimestamp();
        ...
        {
            return BiosEmuThiago.GetHabboById(UserId);
        }

        public Habbo GetDeleter()
        {
            return BiosEmuThiago.GetHabboById(DeleterUserId);
        }

        public GroupForumThreadPost CreatePost(int userid, string message)
        {
            var now = (int)BiosEmuThiago.GetUnixTimestamp();
        ...
        public void SerializeData(GameClient Session, ServerPacket Packet)
        {
            ...
            Packet.WriteInteger((int)(BiosEmuThiago.GetUnixTimestamp() - Timestamp)); //Created Secs Ago
            ...
            Packet.WriteInteger(!isn ? (int)(BiosEmuThiago.GetUnixTimestamp() - lastpost.Timestamp) : 0); //Last message timestamp
            ...
            if (deleter != null)
            {
                ...
                Packet.WriteInteger((int)(BiosEmuThiago.GetUnixTimestamp() - DeletedTimestamp));//deleted secs ago
            }
            else
            {
