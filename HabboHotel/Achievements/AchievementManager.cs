...
namespace Bios.HabboHotel.Achievements
{
    public class AchievementManager
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Achievements.AchievementManager");
        ...
        public AchievementManager()
        {
            ...
            log.Info("» Conquistas Bios Emulador -> PRONTO - BY: Thiago Araujo");
        }
        ...
        public void TryProgressLoginAchievements(GameClient Session)
        {
            ...
            Double daysBtwLastLogin = BiosEmuThiago.GetUnixTimestamp() - Session.GetHabbo().LastOnline;
        ...
        public void TryProgressRegistrationAchievements(GameClient Session)
        {
            ...
            double sinceMember = BiosEmuThiago.GetUnixTimestamp() - (int)Session.GetHabbo().AccountCreated;
        ...
        public void TryProgressHabboClubAchievements(GameClient Session)
        {
            ...
            Double SinceActivation = BiosEmuThiago.GetUnixTimestamp() - Subscription.ExpireTime;
