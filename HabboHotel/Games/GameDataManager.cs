...
namespace Bios.HabboHotel.Games
{
    public class GameDataManager
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Games.GameDataManager");
