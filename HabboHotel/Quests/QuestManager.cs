...
namespace Bios.HabboHotel.Quests
{
    public class QuestManager
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Quests.QuestManager");
        ...
        public void Init()
        {
            ...
            log.Info("» Quest Manager -> PRONTO - BY: Thiago Araujo");
        }
