...
namespace Bios.HabboHotel.Rewards
{
                        ...
                        case RewardType.BADGE:
                            {
                                if (!Session.GetHabbo().GetBadgeComponent().HasBadge(Reward.RewardData))
                                {
                                    ...
                                    Session.SendMessage(RoomNotificationComposer.SendBubble("badge/" + Reward.RewardData, "Você acaba de ganha um emblema!", "/inventory/open/badge"));
                                }
                                break;
                            }
