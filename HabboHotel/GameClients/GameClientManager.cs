...
namespace Bios.HabboHotel.GameClients
{
    public class GameClientManager
    {
        ...
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.GameClients.GameClientManager");
        ...
        public void OnCycle()
        {
            ...
            HandleTimeouts();
            BiosEmuThiago.GetGame().ClientManagerCycleEnded = true;
        }
        ...
        {
            BiosEmuThiago.GetGame().GetClientManager().StaffAlert(new RoomNotificationComposer(Message, Key), 0);
        }

        public void SendBubble(string Message, string Key)
        {
            BiosEmuThiago.GetGame().GetClientManager().SendMessage(new RoomNotificationComposer(Message, Key));
        }
