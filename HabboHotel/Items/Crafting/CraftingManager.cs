...
namespace Bios.HabboHotel.Items.Crafting
{
    public class CraftingManager
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Items.Crafting.CraftingManager");
        ...
        internal void Init()
        {
            ...
            log.Info("» Crafring Manager -> PRONTO - BY: Thiago Araujo");
        }
