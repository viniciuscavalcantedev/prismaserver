...
namespace Bios.HabboHotel.Items.Wired.Boxes.Effects
{
    internal class MoveFurniFromUserBox : IWiredItem, IWiredCycle
    {
        ...
        {
            get { return WiredBoxType.EffectMoveFurniFromNearestUser; }
        }
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (this._next == 0 || this._next < BiosEmuThiago.Now())
                this._next = BiosEmuThiago.Now() + this.Delay;
