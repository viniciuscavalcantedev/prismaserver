...
namespace Bios.HabboHotel.Items.Wired.Boxes.Triggers
{
    class LongRepeaterBox : IWiredItem, IWiredCycle
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type { get { return WiredBoxType.TriggerLongRepeat; } }
        ...
        public void HandleSave(ClientPacket Packet)
        {
            ...
            int Delay = Packet.PopInt() * 5000;

            this.Delay = Delay / 500;
            this.TickCount = Delay / 5000;
            this.StringData = this.TickCount + ";";
        }
