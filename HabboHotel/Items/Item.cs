...
namespace Bios.HabboHotel.Items
{
    ...
    public class Item
    {
        ...
        {
			if (BiosEmuThiago.GetGame().GetItemManager().GetItem(BaseItem, out ItemData Data))
			{
				this.Id = Id;
				this.RoomId = RoomId;
				_room = Room;
				...
				UserID = Userid;
				Username = BiosEmuThiago.GetUsernameById(Userid);
                                            ...
                                            if (ItemTeleporterFinder.IsTeleLinked(Id, GetRoom()))
                                            {
                                                ...
                                                if (true)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        //BiosEmuThiago.GetGame().GetRoomManager().AddTeleAction(new TeleUserData(User.GetClient().GetMessageHandler(), User.GetClient().GetHabbo(), RoomId, TeleId));
                                                    }
        ...
        public ItemData GetBaseItem()
        {
            if (_data == null)
            {
				if (BiosEmuThiago.GetGame().GetItemManager().GetItem(BaseItem, out ItemData I))
					_data = I;
			}
        ...
        public Room GetRoom()
        {
			...
			if (BiosEmuThiago.GetGame().GetRoomManager().TryGetRoom(RoomId, out Room Room))
				return Room;
