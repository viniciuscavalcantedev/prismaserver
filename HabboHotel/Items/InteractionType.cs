namespace Bios.HabboHotel.Items
{
    public enum InteractionType
    {
        ...
        ALERT,
        ONE_WAY_GATE,
        WMTOTEM, // sistema do totem by Thiago Araujo
        LOVE_SHUFFLER,
        HABBO_WHEEL,
        DICE,
        DICE2,
    ...
    public class InteractionTypes
    {
        public static InteractionType GetTypeFromString(string pType)
        {
            switch (pType.ToLower())
            {
                ...
                case "wmtotem": // sistema do totem  By Thiago Araujo
                    return InteractionType.WMTOTEM; // sistema de totem By Thiago Araujo
                case "onewaygate":
                ...
                case "Icessnom":
                    return InteractionType.ICES_SNOM;
                case "rollerskate":
                ...
                case "guild_forum_chat":
                    return InteractionType.GUILD_FORUM_CHAT;
                case "tent":
                ...
                case "rpgthiago":
                    return InteractionType.RPGTHIAGO;
                case "magicchest":
                    return InteractionType.MAGICCHEST;
                case "crafting":
                    return InteractionType.CRAFTING;
                case "caixathiago":
                    return InteractionType.CAIXATHIAGO;
                default:
                    {
