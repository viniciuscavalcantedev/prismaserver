...
namespace Bios.HabboHotel.Rooms
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.HabboHotel.Rooms.RoomManager");
        ...
        public RoomManager()
        {
            ...
            log.Info("» Salas -> PRONTO - BY: Thiago Araujo");
        }
        ...
        public void OnCycle()
        {
            try
            {
                ...
                BiosEmuThiago.GetGame().RoomManagerCycleEnded = true;
            }
            catch (Exception e)
            {
