...
namespace Bios.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = BiosEmuThiago.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (BiosEmuThiago.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((BiosEmuThiago.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return BiosEmuThiago.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
