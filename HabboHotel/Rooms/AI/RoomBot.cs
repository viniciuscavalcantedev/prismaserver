...
using Bios.HabboHotel.Rooms.AI.Types;
using Bios.HabboHotel.Items.Utilities;
using System.Drawing;
using Bios.HabboHotel.Rewards.Rooms.AI.Types;
...
namespace Bios.HabboHotel.Rooms.AI
{
    public class RoomBot
    {
        ...
        public RandomSpeech GetRandomSpeech()
        {
            ...
            return RandomSpeech[BiosEmuThiago.GetRandomNumber(0, (RandomSpeech.Count - 1))];
        }
        #endregion
