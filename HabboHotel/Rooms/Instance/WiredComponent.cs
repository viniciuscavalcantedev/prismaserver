...
using Bios.HabboHotel.Items.Wired.Boxes.Triggers;
using Bios.HabboHotel.Items.Wired.Boxes.Add_ons;
using Bios.HabboHotel.Items.Wired.Boxes.Effects;
using Bios.HabboHotel.Items.Wired.Boxes.Conditions;
using Bios.Database.Interfaces;

namespace Bios.HabboHotel.Rooms.Instance
{
