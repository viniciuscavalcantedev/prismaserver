    ...
    public class Trade
    {
        ...
        public void DeliverItems()
        {
            ...
            foreach (Item I in ItemsOne.ToList())
            {
                ...
                {
                    GetTradeUser(oneId).GetClient().SendNotification(BiosEmuThiago.GetGame().GetLanguageManager().TryGetValue("trade_failed"));
                    GetTradeUser(twoId).GetClient().SendNotification(BiosEmuThiago.GetGame().GetLanguageManager().TryGetValue("trade_failed"));
                    return;
                }
                User1 += I.Id + ";";
            }
