...
namespace Bios.HabboHotel.Rooms.Chat.Commands.User.Fun
{
	...
	internal class BaterCommand : IChatCommand
	{
		public void Execute(GameClient Session, Room Room, string[] Params)
		{
			...
			{
				GameClient clientByUsername = BiosEmuThiago.GetGame().GetClientManager().GetClientByUsername(Params[1]);
				...
				else
				{
					...
					else
					{
						...
						if (user2 != null)
						{
							...
							{
								Session.SendWhisper("Sentimos muito, " + Params[1] + " nao está perto o suficiente!");
								return;
							}
						}
					}
