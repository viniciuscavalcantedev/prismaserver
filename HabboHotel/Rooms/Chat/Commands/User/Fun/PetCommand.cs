    ...
    class PetCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Room Room, string[] Params)
        {
            ...
            if (!Room.PetMorphsAllowed)
            {
                ...
                {
                    Session.SendWhisper("Vá você, você ainda tem uma tranformação");
            ...
            if (Params.Length == 1)
            {
                ...
                Session.SendMessage(new MOTDNotificationComposer("Lista de Mascotes disponiveis! "+BiosEmuThiago.HotelName+"\n" +
                "···········································\n" +
