...
using Bios.Communication.ConnectionManager.Socket_Exceptions;
using log4net;
...
namespace Bios.Communication.ConnectionManager
{
	...
	{
		private static readonly ILog log = LogManager.GetLogger("Bios.Communication.ConnectionManager");
		...
		public void Init(int portID, int maxConnections, int connectionsPerIP, IDataParser parser, bool disableNaglesAlgorithm)
		{
			...
			log.Info("» Configuração bem sucedida das portas: (" + portID + ")! - BY: Thiago Araujo!");
			log.Info("» Conexões IP máximas[" + connectionsPerIP + "]! - BY: Thiago Araujo!");
		}
