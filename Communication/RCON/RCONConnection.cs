...
namespace Bios.Communication.RCON
{
    public class RCONConnection
    {
        ...
        private static readonly ILog log = LogManager.GetLogger("Bios.Communication.RCON.RCONConnection");
        ...
        public void OnCallBack(IAsyncResult iAr)
        {
            try
            {
                ...
                if (!BiosEmuThiago.GetRCONSocket().GetCommands().Parse(data))
                {
