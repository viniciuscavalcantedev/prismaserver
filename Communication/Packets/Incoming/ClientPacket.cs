...
namespace Bios.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (BiosEmuThiago.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return BiosEmuThiago.GetDefaultEncoding().GetString(ReadFixedValue());
        }
