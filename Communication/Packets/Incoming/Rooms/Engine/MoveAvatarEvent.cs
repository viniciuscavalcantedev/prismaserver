    ...
    class MoveAvatarEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Session.GetHabbo()._NUX)
            {
                ...
                Session.SendMessage(new NuxAlertComposer("helpBubble/add/HC_JOIN_BUTTON/Inscreva-se no Club HC para " + BiosEmuThiago.HotelName + " para ganha varias vantagens."));
            }
        }
    }
}