    ...
    class PickupObjectEvent : IPacketEvent
    {
        public void Parse(GameClient Session, ClientPacket Packet)
        {
            ...
            if (ItemRights == true)
            {
                ...
                {
                    GameClient targetClient = BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(Item.UserID);
                ...
                BiosEmuThiago.GetGame().GetQuestManager().ProgressUserQuest(Session, QuestType.FURNI_PICK);
            }
        }
    }
}