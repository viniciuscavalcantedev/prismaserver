...
namespace Bios.Communication.Packets.Incoming.Rooms.AI.Pets
{
    class PlacePetEvent : IPacketEvent
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.Communication.Packets.Incoming.Rooms.AI.Pets.PlacePetEvent");
        ...
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Room.GetRoomUserManager().PetCount > Convert.ToInt32(BiosEmuThiago.GetGame().GetSettingsManager().TryGetValue("room.pets.placement_limit")))
            {
