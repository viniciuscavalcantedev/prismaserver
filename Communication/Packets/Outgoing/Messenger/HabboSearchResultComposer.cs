...
namespace Bios.Communication.Packets.Outgoing.Messenger
{
	class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);
