...
namespace Bios.Communication.Packets.Outgoing.Users
{
	class ProfileInformationComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.ProfileInformationMessageComposer)
        {
            ...
            WriteBoolean((BiosEmuThiago.GetGame().GetClientManager().GetClientByUserID(Data.Id)) != null);
            ...
            WriteInteger(Convert.ToInt32(BiosEmuThiago.GetUnixTimestamp() - Data.LastOnline)); // Last online
