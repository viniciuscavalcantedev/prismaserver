...
namespace Bios.Communication.Packets.Outgoing.Marketplace
{
            ...
            : base(ServerPacketHeader.MarketPlaceOwnOffersMessageComposer)
        {
            ...
            using (IQueryAdapter dbClient = BiosEmuThiago.GetDatabaseManager().GetQueryReactor())
            {
                ...
                if (table != null)
                {
                    ...
                    {
                        int num2 = Convert.ToInt32(Math.Floor((double)(((((double)row["timestamp"]) + 172800.0) - BiosEmuThiago.GetUnixTimestamp()) / 60.0)));
