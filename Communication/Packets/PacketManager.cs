...
using Bios.Communication.Packets.Incoming.Quiz;
using Bios.Communication.Packets.Incoming.Catalog;
using Bios.Communication.Packets.Incoming.Handshake;
using Bios.Communication.Packets.Incoming.Navigator;
using Bios.Communication.Packets.Incoming.Quests;
using Bios.Communication.Packets.Incoming.Rooms.Avatar;
using Bios.Communication.Packets.Incoming.Rooms.Chat;
using Bios.Communication.Packets.Incoming.Rooms.Games;
using Bios.Communication.Packets.Incoming.Rooms.Connection;
using Bios.Communication.Packets.Incoming.Rooms.Engine;
using Bios.Communication.Packets.Incoming.Rooms.Action;
using Bios.Communication.Packets.Incoming.Users;
using Bios.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Bios.Communication.Packets.Incoming.Inventory.Purse;
using Bios.Communication.Packets.Incoming.Sound;
using Bios.Communication.Packets.Incoming.Misc;
using Bios.Communication.Packets.Incoming.Inventory.Badges;
using Bios.Communication.Packets.Incoming.Avatar;
using Bios.Communication.Packets.Incoming.Inventory.Achievements;
using Bios.Communication.Packets.Incoming.Inventory.Bots;
using Bios.Communication.Packets.Incoming.Inventory.Pets;
using Bios.Communication.Packets.Incoming.LandingView;
using Bios.Communication.Packets.Incoming.Messenger;
using Bios.Communication.Packets.Incoming.Groups;
using Bios.Communication.Packets.Incoming.Rooms.Settings;
using Bios.Communication.Packets.Incoming.Rooms.AI.Pets;
using Bios.Communication.Packets.Incoming.Rooms.AI.Bots;
using Bios.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Bios.Communication.Packets.Incoming.Rooms.Furni;
using Bios.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Bios.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Bios.Communication.Packets.Incoming.Help;
using Bios.Communication.Packets.Incoming.Rooms.FloorPlan;
using Bios.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Bios.Communication.Packets.Incoming.Moderation;
using Bios.Communication.Packets.Incoming.Inventory.Furni;
using Bios.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Bios.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Bios.Communication.Packets.Incoming.Inventory.Trading;
using Bios.Communication.Packets.Incoming.GameCenter;
using Bios.Communication.Packets.Incoming.Marketplace;
using Bios.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Bios.Communication.Packets.Incoming.Talents;
using Bios.Communication.Packets.Incoming.HabboCamera;
using Bios.Communication.Packets.Incoming.Rooms.Nux;
using Bios.Communication.Packets.Incoming.QuickPolls;
using Bios.Communication.Packets.Incoming.Help.Helpers;
using Bios.Communication.Packets.Incoming.Rooms.Polls;

namespace Bios.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Bios.Communication.Packets");
        ...
        public void TryExecutePacket(GameClient Session, ClientPacket Packet)
        {
			...
			if (!_incomingPackets.TryGetValue(Packet.Id, out IPacketEvent Pak))
			{
				if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
					log.Debug("PAQUETE DESCONOCIDO: " + Packet.ToString());
				return;
			}
			...
			if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
            {
                if (_packetNames.ContainsKey(Packet.Id))
                    log.Debug("PAQUETE RECIBIDO: [" + Packet.Id + "] " + _packetNames[Packet.Id]);
                else
                    log.Debug("PAQUETE RECIBIDO: [" + Packet.Id + "] UnnamedPacketEvent");
            }
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.RequestBonusRareEvent, new RequestBonusRareEvent());
        ...
        {
            this._incomingPackets.Add(ClientPacketHeader.HabboCameraPictureDataMessageEvent, new HabboCameraPictureDataEvent());
            this._incomingPackets.Add(ClientPacketHeader.PurchaseCameraPictureMessageEvent, new PurchaseCameraPictureEvent());
            this._incomingPackets.Add(ClientPacketHeader.SetRoomThumbnailMessageEvent, new SetRoomThumbnailEvent());
            this._incomingPackets.Add(ClientPacketHeader.PublishCameraPictureMessageEvent, new PublishCameraPictureEvent());
            this._incomingPackets.Add(ClientPacketHeader.ParticipatePictureCameraCompetitionMessageEvent, new ParticipatePictureCameraCompetitionEvent());
        }

        private void RegisterJukebox()
        {
        ...
        private void RegisterNux()
        {
            ...
            this._incomingPackets.Add(ClientPacketHeader.NuxAcceptGiftsMessageEvent, new NuxAcceptGiftsMessageEvent());
        }
        ...
        private void RegisterCatalog()
        {
            ...
            //_incomingPackets.Add(ClientPacketHeader.ConcurrentUsersCompetition, new ConcurrentUsersCompetition());
        ...
        private void RegisterNavigator()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.ToggleStaffPickEvent, new ToggleStaffPickEvent());
        }
        ...
        private void RegisterQuests()
        {
            ...
            //_incomingPackets.Add(ClientPacketHeader.GetCommunityGoalHallOfFameMessageEvent, new GetCommunityGoalHallOfFameEvent());
        }
        ...
        private void RegisterHelperTool()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.HelperSessioChatTypingMessageEvent, new HelperSessioChatTypingEvent());
            _incomingPackets.Add(ClientPacketHeader.HelperSessioChatSendMessageMessageEvent, new HelperSessioChatSendMessageEvent());
        ...
        private void RegisterTalents()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.RetrieveCitizenshipStatus, new RetrieveCitizenshipStatus());
            _incomingPackets.Add(ClientPacketHeader.CheckQuizTypeEvent, new CheckQuizTypeEvent());
        ...
        private void RegisterMisc()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.PongMessageEvent, new PongMessageEvent());
        ...
        private void RegisterForums()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.UpdateForumReadMarkerMessageEvent, new UpdateForumReadMarkerEvent());
            _incomingPackets.Add(ClientPacketHeader.UpdateForumSettingsMessageEvent, new UpdateForumSettingsEvent());
            _incomingPackets.Add(ClientPacketHeader.UpdateForumThreadStatusMessageEvent, new UpdateForumThreadStatusEvent());
        ...
        /* private void RegisterForums()
           {
               _incomingPackets.Add(ClientPacketHeader.AlterForumThreadStateMessageEvent, new GetForumsListDataEvent());
               _incomingPackets.Add(ClientPacketHeader.GetGroupForumDataMessageEvent, new GetForumsListDataEvent());
               
               _incomingPackets.Add(ClientPacketHeader.GetGroupForumThreadRootMessageEvent, new GetGroupInfoEvent());
               _incomingPackets.Add(ClientPacketHeader.PublishForumThreadMessageEvent, new PostGroupContentEvent());
               _incomingPackets.Add(ClientPacketHeader.ReadForumThreadMessageEvent, new UpdateForumReadMarkerEvent());
               _incomingPackets.Add(ClientPacketHeader.UpdateForumSettingsMessageEvent, new UpdateForumSettingsEvent());
        ...
        private void RegisterRoomPolls()
        {
            ...
            //_incomingPackets.Add(ClientPacketHeader.PollAnswerMessageEvent, new PollAnswerEvent());
        ...
        {
            // POLL
            _packetNames.Add(ClientPacketHeader.PollStartMessageEvent, "PollStartEvent");
            _packetNames.Add(ClientPacketHeader.PollRejectMessageEvent, "PollRejectEvent");

            // CRAFT
            _packetNames.Add(ClientPacketHeader.CraftSecretMessageEvent, "CraftSecretEvent");
            _packetNames.Add(ClientPacketHeader.ExecuteCraftingRecipeMessageEvent, "ExecuteCraftingRecipeEvent");
            _packetNames.Add(ClientPacketHeader.GetCraftingItemMessageEvent, "GetCraftingItemEvent");
            _packetNames.Add(ClientPacketHeader.GetCraftingRecipesAvailableMessageEvent, "GetCraftingRecipesAvailableEvent");
            _packetNames.Add(ClientPacketHeader.SetCraftingRecipeMessageEvent, "SetCraftingRecipeEvent");
            ...
            _packetNames.Add(ClientPacketHeader.LTDCountdownEvent, "LTDCountdownEvent");
            //_packetNames.Add(ClientPacketHeader.ConcurrentUsersCompetition, "ConcurrentUsersCompetition"); Termometro de Record de ONs
            _packetNames.Add(ClientPacketHeader.FurniMaticPageEvent, "FurniMaticPageEvent");
            _packetNames.Add(ClientPacketHeader.FurniMaticRecycleEvent, "FurniMaticRecycleEvent");
            _packetNames.Add(ClientPacketHeader.FurniMaticRewardsEvent, "FurniMaticRewardsEvent");
            _packetNames.Add(ClientPacketHeader.AmbassadorWarningMessageEvent, "AmbassadorWarningMessageEvent");
            ...
            _packetNames.Add(ClientPacketHeader.GetHabboClubCenterInfoMessageEvent, "GetHabboClubCenterInfoMessageEvent");
            ...
            _packetNames.Add(ClientPacketHeader.PongMessageEvent, "PongMessageEvent");
            ...
            _packetNames.Add(ClientPacketHeader.NuxAcceptGiftsMessageEvent, "NuxAcceptGiftsMessageEvent");
            //_packetNames.Add(ClientPacketHeader.RoomNuxAlert, "RoomNuxAlert");

            _packetNames.Add(ClientPacketHeader.HandleHelperToolMessageEvent, "HandleHelperToolMessageEvent");
            _packetNames.Add(ClientPacketHeader.CallForHelperMessageEvent, "CallForHelperEvent");
            _packetNames.Add(ClientPacketHeader.AcceptHelperSessionMessageEvent, "AcceptHelperSessionEvent");
            _packetNames.Add(ClientPacketHeader.CancelCallForHelperMessageEvent, "CancelCallForHelperEvent");
            _packetNames.Add(ClientPacketHeader.FinishHelperSessionMessageEvent, "FinishHelperSessionEvent");
            _packetNames.Add(ClientPacketHeader.CloseHelperChatSessionMessageEvent, "CloseHelperChatSessionEvent");
            _packetNames.Add(ClientPacketHeader.HelperSessioChatTypingMessageEvent, "HelperSessioChatTypingEvent");
            _packetNames.Add(ClientPacketHeader.HelperSessioChatSendMessageMessageEvent, "HelperSessioChatSendMessageEvent");
            _packetNames.Add(ClientPacketHeader.InvinteHelperUserSessionMessageEvent, "InvinteHelperUserSessionEvent");
            _packetNames.Add(ClientPacketHeader.VisitHelperUserSessionMessageEvent, "VisitHelperUserSessionEvent");
            _packetNames.Add(ClientPacketHeader.GetGroupForumsMessageEvent, "GetForumsListDataMessageEvent");

            // Jukebox

            _packetNames.Add(ClientPacketHeader.GetJukeboxPlaylistMessageEvent, "GetJukeboxPlayListEvent");
            _packetNames.Add(ClientPacketHeader.LoadJukeboxDiscsMessageEvent, "LoadJukeboxDiscsEvent");
            _packetNames.Add(ClientPacketHeader.GetJukeboxDiscsDataMessageEvent, "GetJukeboxDiscsDataEvent");
            _packetNames.Add(ClientPacketHeader.AddDiscToPlayListMessageEvent, "AddDiscToPlayListEvent");
            _packetNames.Add(ClientPacketHeader.RemoveDiscFromPlayListMessageEvent, "RemoveDiscFromPlayListEvent");


            // TaryetedCagonDios

            _packetNames.Add(ClientPacketHeader.BuyTargettedOfferMessageEvent, "BuyTargettedOfferEvent");

            // Calendar
            _packetNames.Add(ClientPacketHeader.OpenCalendarBoxMessageEvent, "OpenCalendarBoxEvent");

            //Football Gate
            _packetNames.Add(ClientPacketHeader.FootballGateComponent, "FootballGateComponent");

            //Quiz / Manera Habbo
            _packetNames.Add(ClientPacketHeader.CheckQuizTypeEvent, "CheckQuizType");
            _packetNames.Add(ClientPacketHeader.PostQuizAnswersMessageEvent, "PostQuizAnswersMessageEvent");


            //Bonus Rare
            //_packetNames.Add(ClientPacketHeader.RequestBonusRareEvent, "RequestBonusRareEvent");

            //ConcurrentUsers
            //_packetNames.Add(ClientPacketHeader.ConcurrentUsersCompetitionEvent, "ConcurrentUsersCompetition");
            //_packetNames.Add(ClientPacketHeader.GiveConcurrentUsersRewardEvent, "GiveConcurrentUsersReward");

            //Community Goal
            //_packetNames.Add(ClientPacketHeader.CommunityGoalEvent, "CommunityGoalEvent");

            //NUX Spcial
            _packetNames.Add(ClientPacketHeader.GetNuxPresentEvent, "GetNuxPresentEvent");
        }
    }
}